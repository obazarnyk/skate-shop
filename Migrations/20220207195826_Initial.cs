    ...
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OrderForm", x => x.OrderFormId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    ProductId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    SrcFirst = table.Column<string>(type: "nvarchar(300)", maxLength: 300, nullable: false),
                    SrcSecond = table.Column<string>(type: "nvarchar(300)", maxLength: 300, nullable: false),
                    Title = table.Column<string>(type: "nvarchar(60)", maxLength: 60, nullable: false),
                    FullSize = table.Column<string>(type: "nvarchar(60)", maxLength: 60, nullable: false),
